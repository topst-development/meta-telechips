...
IF_MKSWAP(APPLET(mkswap, BB_DIR_BIN, BB_SUID_DROP))
...
IF_SWAPONOFF(APPLET_ODDNAME(swapoff, swap_on_off, BB_DIR_BIN, BB_SUID_DROP, swapoff))
IF_SWAPONOFF(APPLET_ODDNAME(swapon, swap_on_off, BB_DIR_BIN, BB_SUID_DROP, swapon))
